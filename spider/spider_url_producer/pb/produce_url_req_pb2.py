...
produce_url_req = _reflection.GeneratedProtocolMessageType('produce_url_req', (_message.Message,), dict(
  DESCRIPTOR = _PRODUCE_URL_REQ,
  __module__ = 'produce_url_req_pb2'
  # @@protoc_insertion_point(class_scope:spider.produce_url_req)
  ))
_sym_db.RegisterMessage(produce_url_req)
